...
public class UserController {
    ...
    public Result userLogin(@RequestBody @Valid UserLoginParam user, HttpServletRequest request){
        ...
        // 调用service层的登录方法
        UserLoginVO userLoginVO = userServiceImpl.login(user.getLoginName(),user.getPassword(),user.getCode(),request);
    ...
    // 修改用户信息
    @PutMapping("/info")
    @ApiOperation(value = "修改用户信息", notes = "需要请求头token和修改表单的信息")
